...
celular2 = Lanterninha(89, 50)

celular1.enviar_mensagem('oi', celular2)
celular1.enviar_mensagem('tudo bom com você?', celular2)
celular2.caixa_sms

celular2.ver_sms()
celular2.esvaziar_caixa()
celular2.caixa_sms
celular1.esvaziar_caixa()